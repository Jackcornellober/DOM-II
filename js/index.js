...
buttons.forEach((x) => x.addEventListener('contextmenu', event => {event.stopPropagation(); x.textContent = 'Left click dummy!'}))
buttons.forEach((x) => x.addEventListener('click', event => {event.stopPropagation(); if (x.textContent === 'Left click dummy!') {x.textContent = 'You did it!'}}))
buttons.forEach((x) => x.addEventListener('dblclick', event => {event.stopPropagation(); if (x.textContent === 'You did it!') {x.textContent = 'Hey! Stop that!'}}))
